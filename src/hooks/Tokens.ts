...
export function useToken(tokenAddress?: string): Token | undefined | null {
  ...
  const tokenName = useSingleCallResult(token ? undefined : tokenContract as any, 'name', undefined, NEVER_RELOAD)
  ...
  const symbol = useSingleCallResult(token ? undefined : tokenContract as any, 'symbol', undefined, NEVER_RELOAD)
  const symbolBytes32 = useSingleCallResult(token ? undefined : tokenContractBytes32, 'symbol', undefined, NEVER_RELOAD)
  const decimals = useSingleCallResult(token ? undefined : tokenContract as any, 'decimals', undefined, NEVER_RELOAD)
