...
export function getCOREScanLink(
  data: string | number,
...
export function getCOREScanLinkForNft(collectionAddress: string, tokenId: string): string {
...
export function getContract(address: string, ABI: any, signer?: Signer | Provider): Contract {
  ...
  return new Contract(address, ABI, signer ?? simpleRpcProvider as any)
}
