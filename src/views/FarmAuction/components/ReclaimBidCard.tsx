...
const ReclaimBidCard: React.FC = () => {
  ...
  const { isApproving, isApproved, isConfirming, handleApprove, handleConfirm } = useApproveConfirmTransaction({
    ...
    onApprove: () => {
      return callWithGasPrice(cakeContractApprover as any, 'approve', [farmAuctionContract.address, MaxUint256])
    },
    ...
    onConfirm: () => {
      return callWithGasPrice(farmAuctionContract as any, 'claimAuction', [reclaimableAuction.id])
    },
