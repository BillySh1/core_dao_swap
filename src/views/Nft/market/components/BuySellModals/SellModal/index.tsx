...
const SellModal: React.FC<SellModalProps> = ({
  ...
  const { isApproving, isApproved, isConfirming, handleApprove, handleConfirm } = useApproveConfirmTransaction({
    ...
    onApprove: () => {
      return callWithGasPrice(collectionContractSigner as any, 'setApprovalForAll', [nftMarketContract.address, true])
    },
    ...
    onConfirm: () => {
      ...
      if (stage === SellingStage.CONFIRM_TRANSFER) {
        return callWithGasPrice(collectionContractSigner as any, 'safeTransferFrom(address,address,uint256)', [
          account,
          transferAddress,
          nftToSell.tokenId,
        ])
